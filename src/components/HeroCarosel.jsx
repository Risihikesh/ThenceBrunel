...
function HeroCarosel() {
  ...
  return (
    <div className="herocarouseldiv">
      ...
      <AppButton onClick={() => setCurrentSlide((currentSlide + 1) % slides.length)} idname="black" bgcolor="black" color="white" style={{ display: 'inline-flex', alignItems: 'center' }}>
      <span style={{ display: 'inline-flex', alignItems: 'center' }} >Explore More<span><svg id ="carouselsvg" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
