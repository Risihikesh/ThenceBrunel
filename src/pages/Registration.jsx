...
export default function RegistrationForm() {
    ...
    return (
      <div className="w-1/2 mx-auto">
        <div className="text text-center mb-6">
          <span className="font-normal font-fontco text-[#2da950] text-3xl covered">
            Registration Form
          </span>
          <p className="text-5xl pt-2 font-semibold manrope">
  ...
  const Success = () => {
    return (
      <>
        <div className="w-1/2 mx-auto flex justify-center mt-2">
          <div className="text-center ">
            ...
            <div className="w-full">
              <span className=" font-fontco text-[#2DA950] text-3xl covered mt-4">
                Success Submitted
              </span>
              <p className="manrope text-5xl font-semibold my-3">
                Congratulations
              </p>
              <p className="manrope text-xl px- mt-4 text-[#727272]">
                Your request has been successfully submitted to us. We will
                validate your information and reach out to your shortly with
                updates
              </p>
            </div>
            <p className="pt-20 manrope text-[#727272] font-medium text-[20px]">
